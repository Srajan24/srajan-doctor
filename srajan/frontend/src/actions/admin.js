...
export async function verifyAdmin(userId) {
    ...
    try {
        ...
        const res = await axios.get(`${API_BASE_URL}/api/admin/verify?userId=${userId}`, {
        });
...
export async function getPendingDoctors(userId) {
    ...
    try {
        const res = axios.get(`${API_BASE_URL}/api/admin/pending-doctors`)
...
export async function getVerifiedDoctors(userId) {
    ...
    try {
        const res = axios.get(`${API_BASE_URL}/api/admin/verified-doctors`)
...
export async function updateDoctorInfo(formData) {
    ...
    try {
        const response = await axios.put(`${API_BASE_URL}/api/admin/update-doctor-status`, {
            doctorId,
            status,
        });
...
export async function updateDoctorActiveStatus(formData) {
    ...
    if (!res.isAdmin) throw new Error("Unauthorized");
    try {
        const res = await axios.put(`${API_BASE_URL}/api/admin/update-doctor-status-suspend`, {
            doctorId,
            suspend,
        });
...
export async function getPendingPayouts() {
    ...
    try {
        const res = await axios.get(`${API_BASE_URL}/api/payout/pending`);
...
export async function approvePayout({formData, userId}) {
    ...
    try {
        const res = await axios.post(`${API_BASE_URL}/api/payout/approve`, {
            payoutId,
            userId
        });
